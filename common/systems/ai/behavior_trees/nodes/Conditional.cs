...
/// <para>
/// The <see cref="Conditional"/> wraps one child node and evaluates the given <paramref name="condition"/>
...
/// </param>
public class Conditional(string name = "Conditional", int priority = 1, Func<bool>? condition = null) : Decorator(name, priority)
{
	/// <summary>
